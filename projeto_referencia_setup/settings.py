...
SECRET_KEY = 'django-insecure-ymuyhn^rj-2wo2wa2m=s36y*t)c+5s8zk=8u4m7qxuva++%n+l'
...
ROOT_URLCONF = 'projeto_referencia_setup.urls'
...
WSGI_APPLICATION = 'projeto_referencia_setup.wsgi.application'
