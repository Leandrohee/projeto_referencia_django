...
urlpatterns = [
    ...
    path('deletarPedido/<int:pedido_id>', deletarPedido, name='deletarPedido')                      #o <int:pedido_id> quer dizer que o numero na URL depois de "deletarPedido/" sera salvo na variavel "pedido_id". Essa variavel sera enviada como parametro para a funcao editarPedido em views.py
]